...
- [g_game.rs:1637](../rust-doomgeneric/engine/src/g_game.rs#L1637) — the demo file header byte (`gameskill as u8`).
- [p_saveg.rs:696](../rust-doomgeneric/engine/src/p_saveg.rs#L696) — the savegame header byte (`gameskill as u8`).
- [d_net.rs:83](../rust-doomgeneric/engine/src/d_net.rs#L83) — the net game settings `skill` field (`startskill as i32`); [d_net.rs:165](../rust-doomgeneric/engine/src/d_net.rs#L165) prints it.
...
- Integer → enum, [`skill_from_raw`](../rust-doomgeneric/engine/src/d_mode.rs#L30) (panics on an invalid value; a thin wrapper over `SkillType::from_raw`). Callers: [p_saveg.rs:740](../rust-doomgeneric/engine/src/p_saveg.rs#L740), [g_game.rs:1694](../rust-doomgeneric/engine/src/g_game.rs#L1694), [d_net.rs:62](../rust-doomgeneric/engine/src/d_net.rs#L62), [m_menu.rs:994](../rust-doomgeneric/engine/src/m_menu.rs#L994), [m_menu.rs:1012](../rust-doomgeneric/engine/src/m_menu.rs#L1012).
- The `-skill` argument uses `SkillType::from_raw` directly: [d_main.rs:960](../rust-doomgeneric/engine/src/d_main.rs#L960).
...
- **The ticcmd.** [g_game.rs:477](../rust-doomgeneric/engine/src/g_game.rs#L477) returns the chosen weapon's number from [`g_next_weapon`](../rust-doomgeneric/engine/src/g_game.rs#L451); the caller puts it in the buttons byte as `weapon << BT_WEAPONSHIFT` ([g_game.rs:593](../rust-doomgeneric/engine/src/g_game.rs#L593)), which is the demo and network wire format. [p_user.rs:244](../rust-doomgeneric/engine/src/p_user.rs#L244) reads the weapon number back out of the ticcmd with `weapontype_from_raw`.
...
## `WeaponCycle` — `Previous = -1`, `Next = 1` ([g_game.rs:447](../rust-doomgeneric/engine/src/g_game.rs#L447))

**Why the numbers are necessary.** They are arithmetic: [g_game.rs:467](../rust-doomgeneric/engine/src/g_game.rs#L467) does `i += direction as i32` to step through the weapon order table, then wraps with `% len`. `-1` and `+1` *are* the step.
...
## `Direction` — `Down = -1` ([p_spec.rs:251](../rust-doomgeneric/engine/src/p_spec.rs#L251))
...
- [`Direction::to_save`](../rust-doomgeneric/engine/src/p_spec.rs#L264) (`self as i32`) is the only place the value is observed; the movers' savegame writers call it (`saveg_write32(state, str.direction.to_save())` in `p_saveg.rs`).
- Integer → enum, [`Direction::from_save`](../rust-doomgeneric/engine/src/p_spec.rs#L269): `-1 → Down`, `1 → Up`, `2 → InitialWait`, anything else `Still` (a deliberate deviation, see `docs/known-deviations.md`).
...
| `MusicName` | [sounds.rs:4](../rust-doomgeneric/engine/src/sounds.rs#L4) | 25 | [d_main.rs:522](../rust-doomgeneric/engine/src/d_main.rs#L522), [d_main.rs:524](../rust-doomgeneric/engine/src/d_main.rs#L524), [d_main.rs:543](../rust-doomgeneric/engine/src/d_main.rs#L543) … |
...
| `GameMission` | [d_mode.rs:34](../rust-doomgeneric/engine/src/d_mode.rs#L34) | 10 | [d_iwad.rs:164](../rust-doomgeneric/engine/src/d_iwad.rs#L164), [d_iwad.rs:180](../rust-doomgeneric/engine/src/d_iwad.rs#L180), [d_main.rs:817](../rust-doomgeneric/engine/src/d_main.rs#L817) … |
| `MapLump` | [p_setup.rs:232](../rust-doomgeneric/engine/src/p_setup.rs#L232) | 10 | [p_setup.rs:733](../rust-doomgeneric/engine/src/p_setup.rs#L733), [p_setup.rs:735](../rust-doomgeneric/engine/src/p_setup.rs#L735), [p_setup.rs:736](../rust-doomgeneric/engine/src/p_setup.rs#L736) … |
...
| `GameVersion` | [d_mode.rs:67](../rust-doomgeneric/engine/src/d_mode.rs#L67) | 4 | [d_main.rs:723](../rust-doomgeneric/engine/src/d_main.rs#L723), [d_net.rs:85](../rust-doomgeneric/engine/src/d_net.rs#L85), [g_game.rs:1616](../rust-doomgeneric/engine/src/g_game.rs#L1616) … |
...
| `SndDevice` | [i_sound.rs:24](../rust-doomgeneric/engine/src/i_sound.rs#L24) | 4 | [i_sound.rs:80](../rust-doomgeneric/engine/src/i_sound.rs#L80), [i_sound.rs:81](../rust-doomgeneric/engine/src/i_sound.rs#L81), [s_sound.rs:456](../rust-doomgeneric/engine/src/s_sound.rs#L456) … |
...
| `EvType` | [d_event.rs:23](../rust-doomgeneric/engine/src/d_event.rs#L23) | 2 | [am_map.rs:648](../rust-doomgeneric/engine/src/am_map.rs#L648), [g_game.rs:834](../rust-doomgeneric/engine/src/g_game.rs#L834) |
...
| `GameMode` | [d_mode.rs:58](../rust-doomgeneric/engine/src/d_mode.rs#L58) | 1 | [d_net.rs:103](../rust-doomgeneric/engine/src/d_net.rs#L103) |
...
`BWhere` ([p_switch.rs:37](../rust-doomgeneric/engine/src/p_switch.rs#L37)), `DefaultType` ([m_config.rs:12](../rust-doomgeneric/engine/src/m_config.rs#L12)), `DosMemDump` ([i_system.rs:8](../rust-doomgeneric/engine/src/i_system.rs#L8)), `FinaleStage` ([f_finale.rs:38](../rust-doomgeneric/engine/src/f_finale.rs#L38)), `GameAction` ([d_event.rs:2](../rust-doomgeneric/engine/src/d_event.rs#L2)), `GameScreenState` ([d_event.rs:15](../rust-doomgeneric/engine/src/d_event.rs#L15)), `MenuId` ([m_menu.rs:55](../rust-doomgeneric/engine/src/m_menu.rs#L55)), `OverrunTarget` ([p_maputl.rs:179](../rust-doomgeneric/engine/src/p_maputl.rs#L179)), `Plane` ([p_spec.rs:281](../rust-doomgeneric/engine/src/p_spec.rs#L281)), `ResultE` ([p_floor.rs:57](../rust-doomgeneric/engine/src/p_floor.rs#L57)), `Screen` ([v_video.rs:21](../rust-doomgeneric/engine/src/v_video.rs#L21)), `SpriteRotate` ([r_defs.rs:147](../rust-doomgeneric/engine/src/r_defs.rs#L147)), `StChatStateEnum` ([st_stuff.rs:282](../rust-doomgeneric/engine/src/st_stuff.rs#L282)), `StStateEnum` ([st_stuff.rs:277](../rust-doomgeneric/engine/src/st_stuff.rs#L277)), `StairE` ([p_floor.rs:52](../rust-doomgeneric/engine/src/p_floor.rs#L52)), `StateEnum` ([wi_stuff.rs:506](../rust-doomgeneric/engine/src/wi_stuff.rs#L506)), `ThinkerKind` ([p_tick.rs:41](../rust-doomgeneric/engine/src/p_tick.rs#L41)).
