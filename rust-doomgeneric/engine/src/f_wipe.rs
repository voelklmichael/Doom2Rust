...
fn wipe_init_melt(
    f_wipe: &mut FWipeState,
    i_video: &mut IVideoState,
    rng: &mut MRandomState,
    width: i32,
    height: i32,
) {
...
fn wipe_exit_melt(f_wipe: &mut FWipeState) {
    f_wipe.y = Vec::new();
    f_wipe.wipe_scr_start = Vec::new();
    f_wipe.wipe_scr_end = Vec::new();
}
pub fn wipe_start_screen(f_wipe: &mut FWipeState, i_video: &IVideoState) {
